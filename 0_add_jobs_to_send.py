#!/usr/bin/env python3
"""
Given a general job name and a list of parameters from nameFile, takes parameter values as an input and appends all requested job names to the jobsToSend.txt.
"""
